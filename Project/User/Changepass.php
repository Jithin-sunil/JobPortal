...
session_start();
 if(isset($_POST['btn_changepass']))
 {
	...
	$newpass=$_POST['txt_npass'];
	$retypepass=$_POST['txt_pass2'];
	
	
	  $selQery="select * from tbl_user where user_id = '".$_SESSION['uid']."' ";
...
<table width="400" border="1">
  ...
  <tr>
    ...
    <td> <label for="txt_npass"></label>
      <input type="password" name="txt_pass2" id="txt_npass" />
    </td>
  </tr>
  <tr>
    <td colspan="2"><div align="center">
      <input type="submit" name="btn_changepass" id="btn_changepass" value="Change Password" />
