 ...
 $selQry="select * from tbl_user where user_id='".$_SESSION['uid']."' ";
  ...
  <tr>
    ...
    <td><label for="txt_contact"></label>
      <input type="number" name="txt_contact" id="txt_contact" value="<?php echo $data['user_contact']?>"/></td>
  </tr>
  <tr>
    <td>Address</td>
    <td><label for="txt_address"></label>
      <textarea name="txt_address" id="txt_address" cols="40" rows="5" ><?php echo $data['user_address']?></textarea></td>
  </tr>
  <tr>
