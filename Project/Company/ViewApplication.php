<?php
 ...
 if(isset($_GET['aid']))
  ...
  if(isset($_GET['rid']))
  {
   $upQry = "update tbl_application set application_status = 2 where application_id = '".$_GET['rid']."' ";
   if($Con->query($upQry))
   {
	?>   
	   <script>
...
<table width="700" border="1">
  ...
  <tr>
	...
	{
			 ?>
              <a href = "ViewApplication.php?aid=<?php echo $data['application_id']?>">Accept</a><br/>
              <a href = "ViewApplication.php?rid=<?php echo $data['application_id']?>">Reject</a>
	...
	else if($data['application_status'] == 1)
	{
		echo "Accepted";
		?>
         <a href = "ViewApplication.php?rid=<?php echo $data['application_id']?>">Reject</a><br/>
        <?php
	}
