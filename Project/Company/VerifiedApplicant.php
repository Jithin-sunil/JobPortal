...
<title>Verified Applicant</title>
</head>

<body>
<div align="center">
<h3>Verifed Applicants</h3>
<table width="700" border="1">
  ...
  $selQry="select * from tbl_application a 
   ...
   where c.company_id = '".$_SESSION['cid']."' and  a.application_status = 1";
  ...
  ?>
    ...
    <td>
    <a href = "VerifiedApplicant.php?rid=<?php echo $data['application_id']?>">Reject</a>
